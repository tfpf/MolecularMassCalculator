...
///////////////////////////////////////////////////////////////////////////////
// A class to display a window in which the constituent elements of a compound
// can be entered. The molecular mass of the compound will be calculated.
// Although `swing' is supposed to be replaced by `javafx', I chose the former
// because the latter won't get installed on Debian.
///////////////////////////////////////////////////////////////////////////////
public class MolecularMassCalculator extends JFrame
{
    ...
    MolecularMassCalculator(String name)
    {
        ...
        // Button to calculate molecular mass.
        gbc.gridy = 4;
        MolecularMassJButton btnCalculateMass = new MolecularMassJButton("Calculate", fontSize);
        btnCalculateMass.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
    ...
    private void CalculateMolecularMass()
    {
        ...
        {
            String symbol = (String)table.getValueAt(i, 0);

            // Conversion to an integer will not be possible if the entry is
            // empty.
            int number;
